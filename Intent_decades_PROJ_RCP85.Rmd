...
tuning_modif<- function (occ, env, bg.coords, occ.grp, bg.grp, method, algorithm, 
          ...
          progbar, updateProgress, userArgs, pres=PRES) 
{
  if(pres==NULL){
...
bgCellId = sample (x = cellSamples2,size = 2624, replace = F)   #, prob= cellSampProb2    aquí i a les 5 dècades restants
...
cellSampProb2 = cellSampProb[notNA]
   ...
   #L'objectiu és tenir un objecte igual que cellsamples2. 
bgCellId = sample (x = cellSamples2,size = 3207, replace = F)
...
cellSampProb2 = cellSampProb[notNA]
   ...
   #L'objectiu és tenir un objecte igual que cellsamples2. 
bgCellId = sample (x = cellSamples2,size = 5539, replace = F)
...
cellSampProb2 = cellSampProb[notNA]
   ...
   #L'objectiu és tenir un objecte igual que cellsamples2. 
bgCellId = sample (x = cellSamples2,size = 43732, replace = F)
...
cellSampProb2 = cellSampProb[notNA]
   ...
   #L'objectiu és tenir un objecte igual que cellsamples2. 
bgCellId = sample (x = cellSamples2,size = 41691, replace = F)
