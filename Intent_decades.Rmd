...
d.occs <- 'C:/Users/munozferrandiz/Desktop/NETES/Decades' 
...
userOccs3.csv <- read.csv(userOccs.path3)
userOccs4.csv <- read.csv(userOccs.path4)
userOccs5.csv <- read.csv(userOccs.path5)
userOccs6.csv <- read.csv(userOccs.path6)
...
d.envs1961_1970 <- 'D:/quercus/Partage/Pep/Gentiana_Alpina_David/Biovars/decades/1961_1970'
d.envs1971_1980 <- 'D:/quercus/Partage/Pep/Gentiana_Alpina_David/Biovars/decades/1971_1980'
d.envs1981_1990 <- 'D:/quercus/Partage/Pep/Gentiana_Alpina_David/Biovars/decades/1981_1990'
d.envs1991_2000 <- 'D:/quercus/Partage/Pep/Gentiana_Alpina_David/Biovars/decades/1991_2000'
d.envs2001_2010 <- 'D:/quercus/Partage/Pep/Gentiana_Alpina_David/Biovars/decades/2001_2010'
d.envs2010_2020 <- 'D:/quercus/Partage/Pep/Gentiana_Alpina_David/Biovars/decades/2010_2020'
...
cellSampProb = values (obrir1)
cellSampProb2 = cellSampProb[notNA]

   #L'objectiu és tenir un objecte igual que cellsamples2. 
bgCellId = sample (x = cellSamples2,size = 2624, replace = F, prob = cellSampProb2)
bg.xy1 = raster::xyFromCell(envsBgMsk,cell = bgCellId)
bg.xy1 = as.data.frame (bg.xy)
rm(vv)
...
bg.xy2 = raster::xyFromCell(envsBgMsk,cell = bgCellId)
bg.xy2 = as.data.frame (bg.xy)
rm(vv)
...
cellSampProb2 = cellSampProb[notNA]
   ...
   #L'objectiu és tenir un objecte igual que cellsamples2. 
bgCellId = sample (x = cellSamples2,size = 3207, replace = F, prob = cellSampProb2)
bg.xy3 = raster::xyFromCell(envsBgMsk,cell = bgCellId)
bg.xy3 = as.data.frame (bg.xy)
rm(vv)
...
bg.xy4 = raster::xyFromCell(envsBgMsk,cell = bgCellId)
bg.xy4 = as.data.frame (bg.xy)
rm(vv)
...
bg.xy5 = raster::xyFromCell(envsBgMsk,cell = bgCellId)
bg.xy5 = as.data.frame (bg.xy)
rm(vv)
...
bg.xy6 = raster::xyFromCell(envsBgMsk,cell = bgCellId)
bg.xy6 = as.data.frame (bg.xy)
rm(vv)
...
#writeRaster(pred, "prediccioprob5.tif")
